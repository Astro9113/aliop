...
class RemoteFile extends Component {
  ...
  render() {
    const styles = require('./remote.scss');
      ...
      <div className="row">
        <div className="col-lg-8 col-lg-offset-2">
          ...
          <div className="form-group">
            <label>URI：</label>
            <input ref="url" name="net-addr" type="text" className="form-control" id="remote-file-address" placeholder="请输入资源地址"/>
          </div>
          <div className="form-group">
          ...
          <div className={styles['submit-area']}>
            <a className="btn btn-lg btn-success pull-left"
               data-toggle="modal"
