...
class UploadFile extends Component {
  ...
  render() {
    ...
    const stylesUpload = require('../uploadfile/uploadfile.scss');
        ...
        <div className="col-lg-8 col-lg-offset-2">
          <form method="post" >
            <div className={styles['local-file']}>
              ...
              <div />
              <div className={stylesUpload.btn_group}>
                  <a className={'btn btn-lg btn-primary pull-left ' + stylesUpload.btn_save } data-toggle="modal" data-target=".bs-example-modal-lg"
                      onClick={(event) => this.handleUpload(event)}>
                    <i className="fa fa-sign-in"/>{' '}存储
                  </a>
                  <a className={'btn btn-lg btn-success ' + stylesUpload.btn_submit } data-toggle="modal" data-target=".bs-example-modal-lg"
